...
// партию проекта (`−ISSUE`); добавление/правка/удаление автосейвом. Фиксация —
// общая ось `locked` (волна 13, единый `StockDocument`): под замком накладная
// read-only, а до неё склад не двигается вовсе (Ф15). Guard корректности — «лот
// не потреблён ниже» на бэке. Отображаемое имя строки печатается в накладной.
