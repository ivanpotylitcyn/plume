...
| `Counterparty` | Контрагент | Единая внешняя сторона документооборота с ролями (`is_supplier`/`is_customer`): поставщик закупки/заказа/поставки и/или заказчик передачи. Свернул прежний `Supplier` (волна 13, Ф2f+). |
