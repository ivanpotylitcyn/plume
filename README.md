...
- **Панель управления проектом (project dashboard).** Главная точка старта действий,
  «центр управления проектами» — не место «всё видно по проекту», а то, что **ведёт**.
  Отсюда запускаются автоматизированные «большие движения», которые затем руками
  дотачиваются в мутабельных строках конкретных документов. Этапы управления:
