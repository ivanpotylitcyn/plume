...
urlpatterns = [
    ...
    path('purchases/<int:pk>/post/', views.purchase_post, name='purchase-post'),
    path('purchases/<int:pk>/unpost/', views.purchase_unpost, name='purchase-unpost'),
    ...
    path('procurements/<int:pk>/post/', views.procurement_post, name='procurement-post'),
    path('procurements/<int:pk>/unpost/', views.procurement_unpost, name='procurement-unpost'),
